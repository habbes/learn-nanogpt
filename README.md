...
Install python3.x and PyTorch on a CUDA-enabled machine (if the machine does not have a powerful GPU or not CUDA-enabled, reduce the size of the network by reducing number of layers and the size of embeddings vector).
